                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('admin.update.password') }}" class="forms-sample"
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputUsername1" class="form-label"> Confilm New Password </label>
                                    <input type="password" name="new_password_confilm" class="form-control"
                                        id="new_password_confilm" autocomplete="off">
                                </div>
